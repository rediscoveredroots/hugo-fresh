...
> **Note**: There is always an up-to-date config file at [`exampleSite/hugo.yaml`](https://github.com/rediscoveredroots/hugo-fresh/blob/master/exampleSite/hugo.yaml) that contains all possible configurations.
...
hero:
  ...
  - logo: kromo
    url: https://github.com/rediscoveredroots/hugo-fresh
  - logo: infinite
...
footer:
  ...
  socialmedia:
  - link: https://github.com/rediscoveredroots/hugo-fresh
